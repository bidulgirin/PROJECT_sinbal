...
def login_view(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            #username. password에 해당하는 사용자가 있는지 검사(authenticate 기능)
